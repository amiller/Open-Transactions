...
typedef EXPORT std::map	<std::string, OTPseudonym *>	mapOfNyms;
typedef EXPORT std::map	<std::string, OTAccount *>		mapOfAccounts;


class EXPORT OTAgent 
{
private:
...
typedef EXPORT std::map<std::string, OTAgent *> mapOfAgents;
...
typedef EXPORT std::map<std::string, OTPartyAccount *> mapOfPartyAccounts;
...
typedef EXPORT std::map<std::string, OTParty *> mapOfParties;
...
typedef EXPORT std::map<std::string, OTVariable *> mapOfVariables;

// ---------------------------------------

class EXPORT OTClause
{
...
typedef EXPORT std::map<std::string, OTClause *> mapOfClauses;



// ------------------------------------------------------------

class EXPORT OTStashItem
{
...
//
typedef EXPORT std::map<std::string, OTStashItem *> mapOfStashItems;



class EXPORT OTStash
{
...
//
typedef EXPORT std::map<std::string, OTStash *> mapOfStashes;  // Used in OTSmartContract.
...
typedef EXPORT std::multimap	<std::string, std::string> mapOfHooks; 
typedef EXPORT std::map		<std::string, std::string> mapOfCallbacks; 
...
typedef EXPORT std::map<std::string, OTBylaw *> mapOfBylaws;
